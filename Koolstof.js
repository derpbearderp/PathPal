...
const DataScreen = () => {
  ...
  // Dropdown items data
  const dropdownItems = [
    { title: 'Groen: schone lucht', description: 'Geen kans dat je flauw valt in huis en geen gevaarlijke stoffen', color: 'green' },
    { title: 'Oranje: gevaarlijk', description: 'Open de ramen voor genoeg zuurstof, Er is een kans dat je kan flauwvallen', color: 'orange' },
  ...
  return (
    <View style={styles.container}>
      <View style={styles.card}>
        <Text style={styles.cardTitle}>Koolmonoxide</Text>
        <LineChart
          data={data}
      ...
      <View style={[styles.dropdown, dropdownVisible && styles.dropdownActive]}>
        <TouchableOpacity onPress={toggleDropdown} style={styles.dropdownHeader}>
          <Text style={styles.dropdownHeaderText}>Koolmonoxide</Text>
